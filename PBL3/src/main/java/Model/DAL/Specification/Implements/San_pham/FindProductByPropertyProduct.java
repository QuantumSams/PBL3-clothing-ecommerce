...
public class FindProductByPropertyProduct implements Specification<San_pham>{

	private int id;
	private Object[] objects;
	
	public FindProductByPropertyProduct(int id) {
		this.id = id;
	}
	...
	public String getQuery() {
		...
		query.append("WHERE danh_muc_san_pham.id_danh_muc_san_pham = ? ");
