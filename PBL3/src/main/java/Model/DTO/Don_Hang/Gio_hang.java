...
public class Gio_hang {
	...
	public Gio_hang(int id_gio_hang, int id_khach_hang, int id_muc_san_pham, int so_luong) {
		super();
	...
	public String toString() {
		return "Gio_hang [id_gio_hang=" + id_gio_hang + ", id_khach_hang=" + id_khach_hang + ", id_muc_san_pham="
				+ id_muc_san_pham + ", so_luong=" + so_luong + "]";
	}
