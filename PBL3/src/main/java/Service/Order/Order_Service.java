...
public class Order_Service {
	...
	public final String da_huy = "Đã hủy";
	...
	public void add_order(HttpServletRequest req, HttpServletResponse resp) {
		...
		int id_order = new Random().nextInt();
		...
		try {
			List<Integer> sanPhamValues = new ObjectMapper().readValue(muc_san_pham,
		...
		Don_hang don_hang = new Don_hang(id_order, tong_tien, id_khach_hang, id_nhan_vien, so_dien_thoai,
				dia_chi_giao_dich, ngay_gio_dat, ngay_gio_nhan, ghi_chu, trang_thai_don_hang);
