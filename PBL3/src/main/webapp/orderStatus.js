...
const ORDER_STATUS = {
  "Đợi xác nhận đơn hàng": "status status-waiting",
  "Đang vận chuyển": "status status-onTransit",
  "Đã nhận được đơn hàng": "status status-done",
  "Đã huỷ": "status status-cancelled",
};
