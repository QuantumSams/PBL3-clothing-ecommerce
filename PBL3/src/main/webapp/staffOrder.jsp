        ...
        <div class="sidebar">
          ...
          <div class="user-img">
            <a href="staffOrderList.jsp">
              <img src="img/management_logo.png" alt="management_logo">
            </a>
          </div></a>
        </div>
      </div>
      ...
      <div class="container main">
        <div class="container one-page" id="viewProfilePage">
          <div class="container-fluid ps-1 pe-0 py-3 d-flex align-items-center flex-wrap gap-2">
            <a href="staffOrderList.jsp" class="btn btn-primary btn-sm rounded-circle" id="backButton">
              ...
              <div class="row m-0">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <button type="button" class="btn btn-danger p0 w-100" id="cancelOrder" data-bs-toggle="modal" data-bs-target=""><i
