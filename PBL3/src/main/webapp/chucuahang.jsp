                    ...
                    <div class="mainform">
                        ...
                        <div class="inforItem">
                            <div class="header1">
                                <div class="search">
                                    <div class="input">
                                        <span class="iconSearch"><i class="fa-solid fa-magnifying-glass fa-rotate-90"
                    ...
                    <div class="mainform">
                        ...
                        <div class="bodyInfor">
                            <table class="content-table">
                                ...
                                <tbody>
                                    <tr>
                                        <td><img src="386644391_1615327005662931_6147334074894597765_n.jpg" width="50px"
                                                alt="">
                                        </td>
